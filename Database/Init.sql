...
insert into Song (title, link, artist, genre)
  Values ("infinite peace", "https://drive.google.com/uc?export=download&id=1jY3dd9TnEZkFSA6qiR4Ucb1qA4d1DyVl", "kevin macleod", "chill");
 
insert into Song (title, link, artist, genre)
  Values ("concerto iii allegro i", "https://drive.google.com/uc?export=download&id=1olVPcUkrpwby_g4w1oNewWFXft3JNbqa", "dogsounds", "classical");
 
insert into Song (title, link, artist, genre)
  Values ("funkeriffic", "https://drive.google.com/uc?export=download&id=1o72Z3OPYJGKNFQM6tvh-PDsqEv5tQh7W", "kevin macleod", "jazz");
 
insert into Song (title, link, artist, genre)
  Values ("martini sunset", "https://drive.google.com/uc?export=download&id=1tqiPW6idif-OSUNiHeKUoF74hZpGgI_D", "anonymous", "jazz");